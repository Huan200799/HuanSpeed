            ...
            <div class="col-xs-12 col-md-5 col-lg-5">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <select data-placeholder="Choose a Country..." class="standardSelect" tabindex="1" name="parent_id">
                        ...
                        <div class="bootstrap-table">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{asset('admin/category/'.$cate->id.'/edit')}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Sửa</a>
                                    </td>
